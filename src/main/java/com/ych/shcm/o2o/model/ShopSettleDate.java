 ...
 */
public class ShopSettleDate implements Serializable, IWithCreateTime, IWithModifier {

    private static final long serialVersionUID = -5163801883841266267L;
     ...
     * 店铺结算状态
     */
    private ShopSettleStatus status = ShopSettleStatus.UNSETTLED;
